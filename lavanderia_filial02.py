...
def main():
    ...
    nomeFilaLavanderia02 = "fila_lavanderia_filial02"

    def callback(ch, method, properties, body):
        print(f"MATRIZ ENVIOU A SEGUINTE MENSAGEM:\n {body}\n")

    channel.basic_consume(queue=nomeFilaLavanderia02, auto_ack=True, on_message_callback=callback)


    print('''
  	=========================================================
	|                                                       |
	|                   LAVANDERIA: FILIAL 02               |
	|                                                       | 
