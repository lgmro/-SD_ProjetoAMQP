...
def main():
    ...
    nomeFilaLavanderia01 = "fila_lavanderia_filial01"

    def callback(ch, method, properties, body):
        print(f"MATRIZ ENVIOU A SEGUINTE MENSAGEM:\n {body}\n")

    channel.basic_consume(queue=nomeFilaLavanderia01, auto_ack=True, on_message_callback=callback)


    print('''
  	=========================================================
	|                                                       |
	|                   LAVANDERIA: FILIAL 01               |
	|                                                       | 
